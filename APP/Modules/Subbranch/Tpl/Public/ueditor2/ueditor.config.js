    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            [/*'fullscreen', 'source', '|', 'undo', 'redo', '|',*/
                ...
                'insertimage' , 'removeformat' ,'fontsize' , 'forecolor', 'backcolor'   /*, 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe','insertcode', 'webapp', 'pagebreak', 'template', 'background', '|',
