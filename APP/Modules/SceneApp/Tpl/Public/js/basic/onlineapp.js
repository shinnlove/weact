	...
	/****************************************************************************************************/
		...
		haddle_envent_fn: function() {
			...
			car2._on('success', function() {
				...
				if (car2._pageNext == 0 && car2._pageNow == car2._pageNum - 1) {
					...
					//window.location.href="http://www.we-act.cn/weact/SceneApp/basic/fsadf23432treasdf213sfdsa";
				}
			...
			if (!this._isload) {
				...
				function audio_txt(txt, val, time_txt) {
					if (val) {
						...
						$('#song_img').css("background-image", 'url("http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/music_c2_close_1.png")');
						$('#song_img').show();
					} else {
						//txt.text('关闭');
					...
					time_txt = setTimeout(function() {
						...
						$('#song_img').hide();
						$('#song_img').css("background-image", 'url("http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/music_c3_1.png")');
					}, 3000)
				}
			}
		...
		lazy_img: function() {
			...
			lazyNode.each(function() {
				var self = $(this);
				if (self.is('img')) {
					self.attr('src', 'http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/load.gif');
				} else {
					// 把原来的图片预先保存下来
					...
					self.css({
						'background-image': 'url(http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/load.gif)',
		...
		plugin: function() {
			...
			// 音符飘逸
			$('#coffee_flow').coffee({
				steams: ["<img src='http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/audio_widget_01@2x.png' />", "<img src='http://www.we-act.cn/weact/APP/Modules/SceneApp/Tpl/Public/images/basic/audio_widget_01@2x.png' />"],
				steamHeight: 100,
				steamWidth: 44
			});
