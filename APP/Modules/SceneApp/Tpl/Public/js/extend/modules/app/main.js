define(function(require, exports, module) {
	...
	function($item) {
		...
		function() {
			...
			function(e) {
				if (isStart && (activePage || isFirstTime) && ("mousemove" == e.type ? (moveDistanceX = e.pageX - startX, moveDistanceY = e.pageY - startY) : (moveDistanceX = e.touches[0].pageX - startX, moveDistanceY = e.touches[0].pageY - startY), Math.abs(moveDistanceY) > Math.abs(moveDistanceX))) if (moveDistanceY > 0) {
		...
		function() {
			...
			$appLoading.on("webkitTransitionEnd",
			function() {
				$appLoading.remove()
			}),
	...
	App.prototype.showPage = function(page) {
		...
		this._isInitComplete ? window._app_showPage.apply(theClass, [page]) : $(window).one("load",
		function() {
