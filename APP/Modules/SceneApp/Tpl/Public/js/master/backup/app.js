define("./app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./Lottery", "./video"], function(require, exports, module) {
	var $ = require("./zepto");
	$ = require("./touch");
	...
	require("./image"), require("./event"), require("./plugins"), module.exports = {
		init_module: function() {
			global._scrollStop(), document.body.style.userSelect = "none", document.body.style.mozUserSelect = "none", document.body.style.webkitUserSelect = "none", eval(function(t, e, n, i, a, o) {
				if (a = function(t) {
			...
			$(window).on("load", function() {
				var t, e = (new Date).getTime(),
					n = !1,
					i = e - loading_time;
				i >= 2200 && (n = !0), t = n ? 0 : 2200 - i, setTimeout(function() {
					setTimeout(function() {
						$(".m-alert").addClass("f-hide")
					}, 4e3);
					var t = $(".translate-front").data("open");
					1 == t ? ($(".translate-front").removeClass("f-hide"), setTimeout(function() {
				...
				}, t), $('.bigTxt-btn a[href^="http://mp.weixin.qq.com"]').on("click", function() {
					var t = $("#activity_id").val();
					if ("5210" == t || "5211" == t) {
						var e = "5210" == t ? "辣妈帮" : "尚品宅配";
						return _hmt.push(["_trackEvent", e + "微信关注", e + "微信关注点击操作", e + "_" + t]), function(t) {
							setTimeout(function() {
	...
	var i = function() {
			...
			return V.matches = function(t, e) {
				...
				var i, a = t.parentNode,
					o = !a;
				return o && (a = X).appendChild(t), i = ~V.qsa(a, e).indexOf(t), o && X.removeChild(t), i
			}, T = function(t) {
				...
				var i, a, r;
				return O.test(t) && (i = C(N.createElement(RegExp.$1))), i || (t.replace && (t = t.replace($, "<$1></$2>")), e === w && (e = q.test(t) && RegExp.$1), e in H || (e = "*"), r = H[e], r.innerHTML = "" + t, i = C.each(S.call(r.childNodes), function() {
					r.removeChild(this)
				...
				var i;
				if (!t) return V.Z();
				if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && q.test(t)) i = V.fragment(t, RegExp.$1, n), t = null;
				else {
					...
					else if (q.test(t)) i = V.fragment(t.trim(), RegExp.$1, n), t = null;
					else {
						if (n !== w) return C(n).find(t);
						i = V.qsa(N, t)
					}
				...
				var n, a = "#" == e[0],
					...
					r = a || o ? e.slice(1) : e,
					s = W.test(r);
				return i(t) && s && a ? (n = t.getElementById(r)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : S.call(s && !a ? o ? t.getElementsByClassName(r) : t.getElementsByTagName(e) : t.querySelectorAll(e))
				...
				ready: function(t) {
					return Z.test(N.readyState) && N.body ? t(C) : N.addEventListener("DOMContentLoaded", function() {
						t(C)
					}, !1), this
				},
				get: function(t) {
				...
				not: function(t) {
					...
					if (e(t) && t.call !== w) this.each(function(e) {
						...
						var i = "string" == typeof t ? this.filter(t) : r(t) && e(t.item) ? S.call(t) : C(t);
				...
				attr: function(t, e) {
					...
					return "string" == typeof t && e === w ? 0 == this.length || 1 !== this[0].nodeType ? w : "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(n = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : n : this.each(function(n) {
						if (1 === this.nodeType) if (a(t)) for (b in t) v(this, b, t[b]);
				...
				prop: function(t, e) {
					return t = J[t] || t, e === w ? this[0] && this[0][t] : this.each(function(n) {
				...
				css: function(e, n) {
					if (2 > arguments.length) {
						...
						if (!i) return;
						if ("string" == typeof e) return i.style[T(e)] || a.getPropertyValue(e);
						if (G(e)) {
							var o = {};
							return C.each(G(e) ? e : [e], function(t, e) {
								o[e] = i.style[T(e)] || a.getPropertyValue(e)
							}), o
						}
					}
					var r = "";
					...
					else for (b in e) e[b] || 0 === e[b] ? r += c(b) + ":" + h(b, e[b]) + ";" : this.each(function() {
				...
				addClass: function(t) {
					return t ? this.each(function(e) {
						...
						}, this), k.length && y(this, n + (n ? " " : "") + k.join(" "))
					}) : this
				},
				removeClass: function(t) {
					return this.each(function(e) {
						return t === w ? y(this, "") : (k = y(this), m(this, t, e, k).split(/\s+/g).forEach(function(t) {
							k = k.replace(u(t), " ")
						}), void y(this, k.trim()))
					})
				},
				...
				C.fn[e] = function() {
					...
					return 1 > o.length ? this : this.each(function(t, e) {
						a = i ? e : e.parentNode, e = 0 == n ? e.nextSibling : 1 == n ? e.firstChild : 2 == n ? e : null, o.forEach(function(t) {
							...
							_(a.insertBefore(t, e), function(t) {
			...
			}), V.Z.prototype = C.fn, V.uniq = j, V.deserializeValue = x, C.zepto = V, C
		}();
	window.Zepto = i, void 0 === window.$ && (window.$ = i), function(t) {
		...
		function s(n, a, s, l, u, d, f) {
			...
			a.split(/\s/).forEach(function(e) {
				...
				var a = i(e);
				a.fn = s, a.sel = u, a.e in _ && (s = function(e) {
		...
		function c() {}
		function u(t) {
			return t && (t = t.split(";", 2)[0]), t && (t == C ? "html" : t == b ? "json" : _.test(t) ? "script" : w.test(t) && "xml") || "text"
		}
		function h(t, e) {
		...
		t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			return n && n.promise(f), t(u).on("load error", function(o, l) {
				...
				i = arguments
			}, u.src = e.url.replace(/\?(.+)=\?/, "?$1=" + c), y.head.appendChild(u), e.timeout > 0 && (a = setTimeout(function() {
				d("timeout")
			}, e.timeout)), f)
		}, t.ajaxSettings = {
			type: "GET",
			...
			if (a && a.promise(w), n.crossDomain || x("X-Requested-With", "XMLHttpRequest"), x("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), w.overrideMimeType && w.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && x("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers) for (m in n.headers) x(m, n.headers[m]);
			...
			return r.length > 1 && (s.url = r[0], a = r[1]), s.success = function(e) {
				o.html(a ? t("<div>").html(e.replace(x, "")).find(a) : e), l && l.apply(o, arguments)
			}, t.ajax(s), this
		};
...
}), define("./touch", ["./zepto"], function(t, e, n) {
	var i = t("./zepto");
...
}), define("./global", ["./zepto"], function __global(t) {
	var e = t("./zepto"),
		n = function(t) {
	...
	return i
}), define("./page", ["./zepto", "./global"], function __page(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = {
			_page: e(".m-page"),
...
}), define("./media", ["./zepto", "./global"], function __media(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = {
...
}), define("./image", ["./zepto", "./page", "./global"], function __image(t) {
	var e = t("./zepto"),
		n = t("./page"),
		i = {
			lazy_img: function() {
...
}), define("./event", ["./zepto", "./global", "./page", "./image", "./sileFn", "./map", "./ylMap", "./media", "./form"], function __event(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = t("./image"),
...
}), define("./sileFn", ["./zepto", "./global", "./page", "./map", "./ylMap", "./media", "./form"], function __sigeFn(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = t("./map"),
...
}), define("./map", ["./zepto", "./ylMap", "./global", "./page", "./media"], function __map(require, exports, module) {
	var $ = require("./zepto");
	$ = require("./ylMap");
	var global = require("./global"),
		page = require("./page"),
	...
	return __map
}), define("./ylMap", ["./zepto"], function(t, e, n) {
	var i = t("./zepto");
	n.exports = i, function(t) {
		t.fn.ylmap = function(e) {
			...
			return this.each(function() {
				...
				var a, o, r, s, l = t(this),
					...
					m = null,
					v = null,
					y = t('<div id="BDMap" class="BDMap"></div>');
				l.append(y), l.append(t('<div id="transit_result"></div>')), l.append(t('<div class="tit"><p><a href="javascript:void(0)"><span class="css_sprite01"></span>' + c.address + "</a></p></div>")), l.append(t('<p class="map_close_btn">退出</p>')), l.length > 0 && l.height(), f && l.find(".map_close_btn").css("display", "block"), t("#transit_result").length > 0 && "" != t("#transit_result").html() && t(".transitBtn").removeClass("hide");
				var x = function() {
						l.size() > 0 && (o = new BMap.Map(y.attr("id")), r = new BMap.Point(h, u), s = new BMap.Marker(r), o.enableScrollWheelZoom(), o.enableInertialDragging(), o.centerAndZoom(r, 15), o.addOverlay(s), _(), s.addEventListener("click", function() {
							_()
				...
				open_navigate = function(e) {
					...
					var n = e.coords,
						i = n.latitude,
						a = n.longitude;
					v = new BMap.Point(a, i), t(".infoWindow").find("span.State").html("获取信息成功，正在加载中！"), "bus" == p ? bus_transit() : self_transit(), f ? y.parent().addClass("mapOpen") : y.parent().addClass("open")
...
}), define("./form", ["./zepto", "./global", "./page"], function __form(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = t("./page"),
		a = {
	...
	return a
}), define("./plugins", ["./zepto", "./ylMusic", "./fx", "./Lottery", "./global", "./page", "./media", "./video"], function __plugins(t) {
	var e = t("./zepto");
	e = t("./ylMusic");
	var n = t("./Lottery");
	t("./global");
		...
		r = {
			init: function() {
				e("#coffee_flow").coffee({
					...
					steamHeight: 100,
					steamWidth: 44
				}), a.media_init(), o.video_init();
				var t = e(".translate-front").data("open");
				if (1 == t) {
					var n = e("#j-mengban")[0],
						i = "/template/19/img/page_01_bg@2x.jpg",
						s = e("#r-cover").val(),
						l = "image",
						c = 640,
						u = e(window).height(),
						h = r.start_callback;
					r.cover_draw(n, i, s, l, c, u, h)
			...
			start_callback: function() {
				var t = e(".translate-front").data("open");
				if (i.page_start(), e(document).one("touchstart", function() {
					a._audio.play()
				}), 1 == t) {
					if (e("#j-mengban").removeClass("z-show"), setTimeout(function() {
						e("#j-mengban").addClass("f-hide")
					}, 1500), e(".u-arrow").removeClass("f-hide"), !a._audio) return;
					a._audioNode.removeClass("f-hide"), a._audio.play()
...
}), define("./ylMusic", ["./zepto", "./fx"], function(t, e, n) {
	var a = t("./zepto");
...
}), define("./fx", ["./zepto"], function(t, e, n) {
	var i = t("./zepto");
	n.exports = i, function(t, e) {
		...
		t.each(g, function(t, n) {
		...
		}), o = p + "transform", x[r = p + "transition-property"] = x[s = p + "transition-duration"] = x[c = p + "transition-delay"] = x[l = p + "transition-timing-function"] = x[u = p + "animation-name"] = x[h = p + "animation-duration"] = x[f = p + "animation-delay"] = x[d = p + "animation-timing-function"] = "", t.fx = {
			...
			var v, _, w, b = {},
				...
				j = !1;
			if (a === e && (a = t.fx.speeds._default / 1e3), m === e && (m = 0), t.fx.off && (a = 0), "string" == typeof i) b[u] = i, b[h] = a + "s", b[f] = m + "s", b[d] = p || "linear", T = t.fx.animationEnd;
			else {
				_ = [];
				for (v in i) y.test(v) ? C += v + "(" + i[v] + ") " : (b[v] = i[v], _.push(n(v)));
				C && (b[o] = C, _.push(o)), a > 0 && "object" == typeof i && (b[r] = _.join(", "), b[s] = a + "s", b[c] = m + "s", b[l] = p || "linear")
			}
			return w = function(n) {
				if (n !== e) {
					if (n.target !== n.currentTarget) return;
					t(n.target).unbind(T, w)
				} else t(this).unbind(T, w);
				j = !0, t(this).css(x), g && g.call(this)
			}, a > 0 && (this.bind(T, w), setTimeout(function() {
				j || w.call(k)
...
}), define("./Lottery", ["./zepto"], function(t, e, n) {
...
}), define("./video", ["./zepto", "./global"], function(t) {
	var e = t("./zepto"),
		n = t("./global"),
		i = {
			_video: e(".j-video"),
