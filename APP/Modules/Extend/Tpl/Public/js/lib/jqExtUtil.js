// JavaScript Document
define('lib/jqExtUtil', [], function(require, exports, module) {
	...
	module.exports = {
		...
		getQuery: function(key) {
			...
			if (search.indexOf('?') != -1) {
				...
				return module.exports.parseStr(str, key); // 进行解析
			}
		},
		/**
		 * 判断对象是否为空函数。
		...
		mb_strlen: function(str) {
			...
			for(var i = 0; i < str.length; i++) {
				len += str.charCodeAt(i) < 0 || str.charCodeAt(i) > 255 ? (module.exports.charset.toLowerCase() === 'utf-8' ? 3 : 2) : 1;
			}
			return len;
		},
		/**
		...
		strLenCalc: function(obj, showId, maxlen) {
			var v = obj.value, maxlen = !maxlen ? 200 : maxlen, curlen = maxlen, len = module.exports.strlen(v); // 默认可以输入200字符
