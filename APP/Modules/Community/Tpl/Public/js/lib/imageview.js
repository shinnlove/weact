...
define.pack("./init",["./tmpl"],function(require, exports, module){
    ...
    var ImageView = {
         ...
         * }
         */
        init : function(photos, index, config, picClass){
            var self = this;
            index = +index || 0;
            this.config = $.extend({
                fade: true
...
_p(height);
__p.push('px;"></li>');
}__p.push('</ul>    <span class="ui-loading white" id="J_loading"><div class="loadicon"><span class="blockG" id="rotateG_01"></span><span class="blockG" id="rotateG_02"></span><span class="blockG" id="rotateG_03"></span><span class="blockG" id="rotateG_04"></span><span class="blockG" id="rotateG_05"></span><span class="blockG" id="rotateG_06"></span><span class="blockG" id="rotateG_07"></span><span class="blockG" id="rotateG_08"></span></div></span><span id="blurTip" class="slideText1" style="position: absolute;margin: -40px 0 0 -40px;left: 35%;top: 50%;display:none">想看更多照片么，快来赞一下啦~</span><p class="counts"><span class="value" id="J_index">');
_p(index+1);
__p.push('/');
_p(photos.length);
__p.push('</span></p>');
