/*<script type="text/javascript" src="js/scroll-multi.js"></script>
...
function() {
	function a(a) {
		"undefined" == typeof WeixinJSBridge || "undefined" == typeof WeixinJSBridge.invoke ? setTimeout("loadWeixin(" + a + ")", 200) : a()
	}
	$(document).ready(function() {
		function b(a) {
			return "A" != a[0].tagName.toUpperCase() || "#" == a.prop("href") && 0 == a.prop("href").indexOf("javascript") ? !1 : !0
		}
		$(document).on("click", "IMG", function() {
			var c, d;
			$(this).attr("data-imgs") || (c = [], c[0] = this.src, d = $(this).parent(), b(d) || b(d.parent()) || b(d.parent().parent()) || a(function() {
...
//此处js查询购物车有无商品
     /*$.ajax({
        url:'http://weigou.qq.com/wkd/modulepage/json/queryCmdyCount',
        data:{},
        dataType :'json',
        cache:false,
        type:'post',
        ...
        success:function (data, textStatus) {
            if(data.data) {
                $("#cartNum").text(data.data).removeClass("qb_none");
            }
        }
     });*/

$(function() {
	var e = /[\?|&]autobid=([\w]+)/.exec(window.location.search);
	e && e[1] && "false" == e[1] || -1 != window.location.href.indexOf("autobid=false") ? $("a").each(function() {
		var e = $(this),
			t = e.attr("href");
		(0 == t.indexOf("http://m.buy.qq.com/p/item/wxdetails.xhtml") || 0 == t.indexOf("http://weigou.qq.com/o2ov1/cn/item/preview.xhtml") || 0 == t.indexOf("http://mm.wanggou.com/item/weishop.shtml") || 0 == t.indexOf("http://bases.wanggou.com/itemweb/item?scence=102")) && t.indexOf("?") > 0 && t.indexOf("&bid=") > 0 && e.attr("href", t.replace(/bid=\w+&?/g, "").replace(/(\?|&)$/, ""))
	}) : $("a").each(function() {
		var e = $(this),
			t = e.attr("href");
		(0 == t.indexOf("http://m.buy.qq.com/p/item/wxdetails.xhtml") || 0 == t.indexOf("http://weigou.qq.com/o2ov1/cn/item/preview.xhtml") || 0 == t.indexOf("http://mm.wanggou.com/item/weishop.shtml") || 0 == t.indexOf("http://bases.wanggou.com/itemweb/item?scence=102")) && t.indexOf("?") > 0 && -1 == t.indexOf("&bid=") && e.attr("href", t + "&bid=" + "2200895116")
	})
});
...
try {
	...
	function() {
		...
		t.prototype = {
			init: function(t) {
				this.url = window.location.href, this.hrefUrlPart = t, this.hrefHashPart = "";
				var e = t.indexOf("#");
				0 > e || (this.hrefUrlPart = t.substring(0, e), this.hrefHashPart = t.substring(e))
			},
			appendParam: function(t, e) {
				return this.hrefUrlPart += this.hrefUrlPart.indexOf("?") < 0 ? "?" + t + "=" + e : "&" + t + "=" + e, this
			},
			getHref: function() {
				return this.hrefUrlPart + this.hrefHashPart
			},
			appendShopId: function() {
				var t = /[^\w]shopId=(\w+)/.exec(this.url);
				if (!t) return this;
				var e = /[^\w]shopId=(\w+)/.exec(this.hrefUrlPart);
				if (e) return this;
				var r = t[1];
				return this.appendParam("shopId", r), this
			},
			appendPtag: function() {
				var t = /[\?|&]ptag=([\.\w]+)/.exec(this.hrefUrlPart);
				return t ? this : (this.appendParam("ptag", "50001.1.1"), this)
			}
		}, window.addEventListener("load", function() {
			for (var e = document.getElementsByTagName("A"), r = {}, a = function() {
					for (var t = [], e = 0; e < localStorage.length; ++e) try {
						var n = localStorage.key(e);
						if (0 == n.search("pv-cache-")) {
							var i = localStorage[n].split("\n");
							3 != i.length || r[i[0]] || (t.push({
								time: i[0],
								target: i[1],
								source: i[2]
							}), r[i[0]] = n)
					...
					t.length ? $.ajax({
						type: "POST",
						url: "http://weigou.qq.com/wkd/click.json",
						contentType: "application/json",
						data: JSON.stringify({
							pvs: t
						}),
						complete: function(e) {
							for (var n = "ok" == e.responseText, i = 0; i < t.length; ++i) n && localStorage.removeItem(r[t[i].time]), delete r[t[i].time];
							setTimeout(a, 3e3)
						}
					}) : setTimeout(a, 3e3)
				}, n = 0; n < e.length; ++n)!e[n].href || 0 != e[n].href.indexOf("http:") && 0 != e[n].href.indexOf("https:") || (e[n].href = new t(e[n].href).appendShopId().appendPtag().getHref(), e[n].addEventListener("click", function(t) {
